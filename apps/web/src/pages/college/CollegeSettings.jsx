...
import { GraduationCap, Bell, Shield, Save, LogOut } from 'lucide-react';
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p style={{ color: 'var(--text-secondary)', marginTop: 'var(--space-2)' }}>Manage your college account</p>
      </div>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-6)' }}>
        <Card className="animate-fade-in-up"><CardBody>
          <div className="flex items-center gap-2 mb-6"><GraduationCap size={18} style={{ color: 'var(--primary-600)' }} /><h3 className="card-title">Account Information</h3></div>
          <Input label="College Name" defaultValue={user?.name || 'IIT Delhi'} />
        ...
        <Card className="animate-fade-in-up delay-1"><CardBody>
          ...
          {[{ key: 'email', label: 'Email Notifications', desc: 'Receive updates via email' }, { key: 'reports', label: 'Monthly Reports', desc: 'Get monthly analytics reports' }, { key: 'alerts', label: 'Placement Alerts', desc: 'Notify when students get placed' }].map((n) => (
        ...
        <Card className="animate-fade-in-up delay-3"><CardBody>
          ...
          <p className="text-sm text-secondary mb-4">Log out of your college account.</p>

    ...
    protected void doFilterInternal(
        ...
        if (StringUtils.hasText(jwt) && SecurityContextHolder.getContext().getAuthentication() == null) {
            if (jwtService.isTokenValid(jwt)) {
                ...
                Long collegeId = jwtService.extractCollegeId(jwt);
                Long companyProfileId = jwtService.extractCompanyProfileId(jwt);
                Long studentProfileId = jwtService.extractStudentProfileId(jwt);
